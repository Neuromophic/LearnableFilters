...
parser = argparse.ArgumentParser(prog = 'Printed Neuromorphic Circuits with Learnable Filters',
...
parser.add_argument('--coupling_factor',       type=float,     default=0.1,                   help='noise that caused by the circuit coupling')
# regularization
